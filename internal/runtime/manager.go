...
func (m *Manager) EnsureDirs() error {
	for _, comp := range []Component{ComponentClawDeckX, ComponentOpenClaw} {
...
func (m *Manager) GetStatus(comp Component) Status {
	...
	switch comp {
	case ComponentClawDeckX:
		st.ImageVersion = imageClawDeckXVersion()
...
func (m *Manager) GetAllStatus() AllStatus {
	return AllStatus{
		IsDocker:  IsDocker(),
		ClawDeckX: m.GetStatus(ComponentClawDeckX),
